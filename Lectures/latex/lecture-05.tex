...
\subsubsection*{Binary System Basics}
...
\subsubsection*{Place Value Calculation}
...
\end{itemize}\textbf{N-Bit Unsigned Range}
\begin{itemize}
...
\end{itemize}\textbf{Purpose of Two's Complement}
\begin{itemize}
...
\end{itemize}\textbf{Positive Numbers}
\begin{itemize}
...
\end{itemize}\textbf{Negative Numbers}
\begin{itemize}
\item Represented as $2^N - |\text{value}|$
...
\end{itemize}\textbf{ARM Instructions for Sign Extension}
\begin{itemize}
...
\end{itemize}\textbf{Why Hexadecimal?}
\begin{itemize}
...
\end{itemize}\textbf{32-Bit Instruction Format}
\begin{itemize}
...
\end{itemize}\textbf{Condition (4 bits, bits 28-31)}
\begin{itemize}
...
\end{itemize}\textbf{I bit (bit 25)}
\begin{itemize}
\item 0 = Operand2 is register
\item 1 = Operand2 is immediate value

\end{itemize}\textbf{Opcode (4 bits, bits 21-24)}
\begin{itemize}
...
\end{itemize}\textbf{S bit (bit 20)}
\begin{itemize}
\item 0 = Don't update condition flags
\item 1 = Update flags (CPSR)

\end{itemize}\textbf{Rn (4 bits, bits 16-19)}
\begin{itemize}
\item First operand register number
\item 0000 = R0, 0001 = R1, etc.

\end{itemize}\textbf{Rd (4 bits, bits 12-15)}
\begin{itemize}
\item Destination register number

\end{itemize}\textbf{Operand2 (12 bits, bits 0-11)}
\begin{itemize}
...
\end{itemize}\textbf{Allowed Immediates}
\begin{itemize}
...
\end{itemize}\textbf{Assembler Handling}
\begin{itemize}
...
\begin{lstlisting}[language={[ARM]Assembler}]
LSL R0, R1, #3       ; R0 = R1 × 8 (multiply by 8)
